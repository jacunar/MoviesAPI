...
[TestClass]
public class AccountControllerTests: BasePruebas {
    [TestMethod]
    public async Task CrearUsuario() {
        var nameDb = Guid.NewGuid().ToString();
        await CrearUsuarioHelper(nameDb);
    ...
    public async Task UsuarioNoPuedeLoguearse() {
        ...
        var userInfo = new UserInfo() { Email = "ejemplo@hotmail.com", Password = "passwordX" };
    ...
    private async Task CrearUsuarioHelper(string nameDb) {
        var cuentasController = ConstruirCuentasController(nameDb);
        var userInfo = new UserInfo() { Email = "ejemplo@hotmail.com", Password = "Aa123456!" };
